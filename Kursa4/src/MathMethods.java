public class MathMethods {
    ...
    public static void mnk(double[] x, double[] y) {
        ...
        System.out.println("Поток1 готов");
    }
    ...
    public static void square(double[] x, double[] y) {
        ...
        System.out.println(a1+"*X^2+"+b1+"*X+"+c2);
        System.out.println("Поток2 готов");
    ...
    public static void exp(double[] x, double[] y) {
        int n = x.length;
        ...
        System.out.println("Поток3 готов");
